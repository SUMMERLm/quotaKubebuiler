...
import (
	...
	serverlessv1 "github.com/SUMMERLm/quota/api/v1"
)
...
//+kubebuilder:rbac:groups=serverless.pml.com.cn,resources=quotas/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=serverless.pml.com.cn,resources=quotas/finalizers,verbs=update
